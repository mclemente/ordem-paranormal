...
function chatTemplate(skillName: string, earnIncomeResult: EarnIncomeResult): string {
    ...
    <div class="pf2e chat-card">
        <header class="card-header flexrow">
            <img src="systems/ordem-paranormal/icons/equipment/treasure/currency/gold-pieces.webp" title="Income" width="36" height="36">
...
function isProficiencyWithoutLevel() {
    return game.settings.get("ordem-paranormal", "proficiencyVariant") === "ProficiencyWithoutLevel";
}
