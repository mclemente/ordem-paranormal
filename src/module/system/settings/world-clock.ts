...
export class WorldClockSettings extends FormApplication {
    static override get defaultOptions(): FormApplicationOptions {
        return mergeObject(super.defaultOptions, {
            ...
            template: "systems/ordem-paranormal/templates/system/settings/world-clock/index.html",
            width: 550,
            height: "auto",
            closeOnSubmit: true,
        });
    ...
    override activateListeners($html: JQuery): void {
        ...
        $html.find("button.reset-world-time").on("click", async () => {
            const template = await renderTemplate(
                "systems/ordem-paranormal/templates/system/settings/world-clock/confirm-reset.html"
            );
            Dialog.confirm({
                title: title,
                content: template,
